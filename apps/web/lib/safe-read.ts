 ...
 * every @cc/service-* package defines its own error class and there is no
 * cross-service type guard to import, but the `upstream_unavailable` / 502
 * contract is common to all of them.
 */
