...
import { deleteDraft, saveDraft } from "@cc/service-order";
import { NextResponse } from "next/server";

import { handlePortal, requirePortal } from "@/lib/portal-route";

/**
 * One draft. The id is not trusted to belong to the caller's sold-to
 ...
 * forbidden (CLAUDE.md rule 5). A draft that has already become a sales
 * order is equally not found — it is a SAP document by then.
 */
