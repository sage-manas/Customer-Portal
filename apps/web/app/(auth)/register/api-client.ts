...
export async function startApplication(): Promise<{
  ...
  return parse(await fetch("/api/onboarding", { method: "POST" }));
}
...
export async function fetchApplication(
  ...
  return parse(
    await fetch(`/api/onboarding/${applicationId}`, { headers: { [TOKEN_HEADER]: draftToken } }),
  );
}
...
export async function saveStep(
  ...
  return parse(
    await fetch(`/api/onboarding/${applicationId}/step/${step}`, {
      method: "PUT",
...
export async function verifyGstin(
  ...
  return parse(
    await fetch(`/api/onboarding/${applicationId}/gstin-verify`, {
      method: "POST",
...
export async function uploadDocument(
  ...
  return parse(
    await fetch(`/api/onboarding/${applicationId}/documents/${kind}`, {
      method: "POST",
      headers: { [TOKEN_HEADER]: draftToken },
      body: form,
    }),
...
export async function submitApplication(
  ...
  return parse(
    await fetch(`/api/onboarding/${applicationId}/submit`, {
      method: "POST",
      headers: { [TOKEN_HEADER]: draftToken },
    }),
  );
